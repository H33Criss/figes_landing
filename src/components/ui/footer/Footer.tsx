    ...
    return (
        <div className="flex items-center w-full mt-20 ">
            <footer className="w-full text-gray-700  body-font">
                <div
                    className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:mx-0 md:ml-auto md:mr-28 md:items-center lg:items-start md:flex-row md:flex-no-wrap">
                    ...
                    <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                        <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                            ...
                            <nav className="mb-10 list-none">
                                <li className="mt-3">
                                    <a className="text-gray-500 cursor-pointer hover:text-gray-300">Company</a>
                                </li>
                                <li className="mt-3">
                                    <a className="text-gray-500 cursor-pointer hover:text-gray-300">Careers</a>
                                </li>
                                <li className="mt-3">
                                    <a className="text-gray-500 cursor-pointer hover:text-gray-300">Blog</a>
                                </li>
                            </nav>
                        </div>
                        <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <div >
                    <div className="container text-center px-5 py-4 mx-auto">
                        <p className="text-sm text-gray-200 capitalize xl:text-center">© 2023 All rights reserved </p>
                    </div>
                </div>
            </footer>
